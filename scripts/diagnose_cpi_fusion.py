...
def write_report(summary: pd.DataFrame, env: pd.DataFrame, out_path: Path) -> str:
    ...
    report_lines += [
        ...
        "   instrument was deployed). Documented in README.md.",
        "",
        ...
        "",
        "4. STALE PARQUET AT data/raw/combined_env_si_airtemp_01.parquet",
        "   This older file uses 'Tair' (not 'Tair_C') and covers only 6 campaigns.",
        "   Downstream code referencing it will silently get NaN Tair columns.",
        "   Use data/out/combined_env_data.parquet instead.",
        "",
        ...
        "",
        "7. MIDCIX LOW TIMESTAMP MATCH (~26%)",
        "   JLH data files exist only for Apr 17, 19, 30, May 2, 3, 5, 6.",
        "   CPI images on Apr 22 (17k) and Apr 27 (18k) have no env data.",
        "   These are genuine data gaps — no JLH files exist for those dates.",
        "",
